"""
3I/ATLAS proximity calculator (single-file) - versão com design melhorado + Mkm + gráfico de distâncias
"""
...
class ProximityApp:
    ...
    def calculate(self):
        ...
        try:
            ...
            distances_mkm = [(p[1] * AU_TO_KM) / 1_000_000 for p in distances]  # Mkm
